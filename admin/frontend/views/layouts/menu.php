...
<div class="layui-layout layui-layout-admin">
    <div class="layui-header header header-demo">
        <div class="layui-main">
            <a class="logo" href="?r=index/index">
                X-admin v1.0
            </a>
            <ul class="layui-nav" lay-filter="">
                <li class="layui-nav-item"><img src="./images/f11.png" class="layui-circle" style="border: 2px solid #A9B7B7;" width="35px" alt=""></li>
                <li class="layui-nav-item">
                    <a href="javascript:;"><?php echo $admin?></a>
                    <dl class="layui-nav-child"> <!-- 二级菜单 -->
                        <dd><a href="">个人信息</a></dd>
                        <dd><a href="?r=login/out">切换帐号</a></dd>
                        <dd><a href="?r=login/out">退出</a></dd>
                    </dl>
                </li>
                <!-- <li class="layui-nav-item">
                  <a href="" title="消息">
            ...
            <ul class="layui-nav layui-nav-tree site-demo-nav" lay-filter="side">
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        <dd class="">
                            <a href="javascript:;" _href="?r=moneytrend/index">
                                <cite>资金动向查看</cite>
                            </a>
                        </dd>
                    </dl>
                    <dl class="layui-nav-child">
                        <dd class="">
                            <a href="javascript:;" _href="?r=withdrawals/index">
                                <cite>用户提现申请</cite>
                            </a>
                        </dd>
                    </dl>
                    <dl class="layui-nav-child">
                        <dd class="">
                            <a href="javascript:;" _href="?r=moneytrend/moenycount">
                                <cite>网站资金统计</cite>
                            </a>
                        </dd>
                    </dl>
...
<!--                        <dd class="">-->
<!--                        <dd class="">-->
<!--                            <a href="javascript:;" _href="?r=carousel/index">-->
<!--                                <cite>轮播列表</cite>-->
<!--                            </a>-->
<!--                        </dd>-->
<!--                        </dd>-->
...
<!--                </li>-->
                <li class="layui-nav-item">
                    <a class="javascript:;" href="javascript:;">
                        <i class="layui-icon" style="top: 3px;">&#xe642;</i><cite>投资项目管理</cite>
                    </a>
                    <dl class="layui-nav-child">
                        <dd class="">
                        <dd class="">
                            <a href="javascript:;" _href="?r=project/index">
                                <cite>项目列表</cite>
                            </a>
                        </dd>
                        </dd>
                        <dd class="">
                        <dd class="">
                            <a href="javascript:;" _href="?r=project/add">
                                <cite>投资项目添加</cite>
                            </a>
                        </dd>
                        </dd>
...
<!--                        </dd>-->
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        <dd class="">
                            <a href="javascript:;" _href="?r=admin/index">
                                <cite>管理员列表</cite>
                            </a>
                        </dd>
                        <dd class="">
                            <a href="javascript:;" _href="?r=admin/add">
                                <cite>新增管理员</cite>
                            </a>
                        </dd>

                        <dd class="">
                            <a href="javascript:;" _href="?r=admin/log">
                                <cite>操作记录</cite>
                            </a>
                        </dd>
    ...
    <div class="layui-tab layui-tab-card site-demo-title x-main" lay-filter="x-tab" lay-allowclose="true">
        ...
        <div class="layui-tab-content site-demo site-demo-body">
            <div class="layui-tab-item layui-show">
                <iframe frameborder="0" src="?r=index/welcome" class="x-iframe"></iframe>
            </div>
        </div>
    </div>
